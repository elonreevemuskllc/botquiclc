"""
Bot principal pour surveiller TikTok et interagir avec les nouvelles vidéos
"""
import json
import time
import logging
...
class TikTokBot:
    """Bot principal pour surveiller TikTok et automatiser les interactions"""
    ...
    def __init__(self, config_path: str = "config.json"):
        ...
        logger.info("🤖 Bot TikTok initialisé")
    ...
    def run(self):
        ...
        logger.info(f"🚀 Démarrage du bot - Surveillance de {len(target_users)} utilisateur(s)")
